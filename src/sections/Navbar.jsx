        ...
        <div className={`fixed inset-x-0 z-20 w-full ${!isOpen ? 'backdrop-blur-lg bg-primary/40' : ''}`}>
            <div className="mx-auto c-space max-w-7xl">
                <div className="flex items-center justify-between py-2 sm:py-0">
                    <a href="/portfolio/" className="text_xl font-bold transition-colors text-neutral-400 hover:text-white">
                        Julien
                    </a>
                    <button onClick={() => setIsOpen(!isOpen)} className="flex cursor-pointer text-neutral-400 hover:text-white focus:outline-none sm:hidden">
                        <img src={isOpen ? "/portfolio/assets/close.svg" : "/portfolio/assets/menu.svg"} className="w-6 h-6 z-40" alt="toggle" />
                    </button>
